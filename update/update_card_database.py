...
# Check cards in all decklists and compare vs local card database.
# Pull any new cards from moxfield and save to local card database.
# Returns # of new cards added
# This is typically run from the update_all.py script
...
def main():
    ...
    print(f"Done. Card Database has {len(card_db)} cards.")
